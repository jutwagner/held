    ...
    <div className="bg-gradient-to-br from-slate-50 to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl space-y-6 md:space-y-8">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="font-serif text-xl text-gray-900 dark:text-gray-100">Provenance</h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Where was this acquired?"
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="How was this object acquired? (Purchase, gift, inheritance, etc.)"
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  />
                </div>
              </div>
                ...
                {data.acquisitionDate && (
                  <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm text-gray-500 dark:text-gray-400">Acquired</div>
                  ...
                  <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-gray-900 dark:text-gray-100">{data.transferMethod}</div>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {!data.serialNumber && !data.origin && !data.acquisitionDate && !data.transferMethod && (
                  <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                    <div className="w-12 h-12 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Hash className="h-6 w-6 text-gray-400 dark:text-gray-500" />
                    </div>
                    <p className="text-sm">No identity information added yet</p>
                    <p className="text-xs text-gray-400 dark:text-gray-500">Add serial number, origin, and acquisition details</p>
                  </div>
                )}
              </div>
            )}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Certificate number, issuer, or details"
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  />
                </div>
              ...
              <div className="space-y-3">
                {data.certificateOfAuthenticity && (
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">Certificate of Authenticity</div>
                ...
                {data.certificateUrl && (
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm text-gray-500 dark:text-gray-400 mb-2">Certificate URL</div>
                        <a href={data.certificateUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm break-all">
                          {data.certificateUrl}
                        </a>
                      </div>
                    </div>
                ...
                {!data.certificateOfAuthenticity && !data.certificateUrl && (
                  <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-xs text-gray-400 dark:text-gray-500">Add certificate details or upload images</p>
                  </div>
                )}
              </div>
            )}
