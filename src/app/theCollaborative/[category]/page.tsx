...
export default function TheCollaborativeCategoryPage({ params }: TheCollaborativePageProps) {
  ...
  }, [allRotations, allPosts, params.category]);
      ...
      <div className="held-container held-container-wide py-10">
        <div className="flex sm:flex-row justify-between items-start sm:items-center mb-10">
          <div>
            ...
            <p className="text-gray-600/90 dark:text-gray-300/90">
              {params.category ? `${params.category} shared content` : 'shared Registry Rotations'}
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500 dark:text-gray-400">
            {params.category ? `No ${params.category} content available.` : 'No shared content available.'}
          </p>
        ) : (
